...
void select_frames(VideoCapture& cap, vector<Mat>& out_frames_selected, int w, int h,int n_quads_rows,int num_quads_cols){
    //util for save frame
    float x_quad_lenght = h/num_quads_cols;
    float y_quad_lenght = w/num_quads_cols;
...
int main()
{
    ...
    int delay_time = 55;
    select_frames_by_time(cap, selected_frames,delay_time,NUM_FRAMES_FOR_CALIBRATION);
    select_frames(cap,selected_frames,w,h,4,3);
